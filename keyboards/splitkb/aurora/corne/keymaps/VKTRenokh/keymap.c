...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ESCAPE),
    ...
    [1] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL,  KC_ESC,  CW_TOGG, KC_CAPS, XXXXXXX, QK_REP,        TD(TD_LEFT_HOME), KC_DOWN,  KC_UP,   TD(TD_RIGHT_END), XXXXXXX, KC_CAPS,
    ...
    [2] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL,  XXXXXXX, XXXXXXX, QK_REP, QK_LOCK, XXXXXXX,       KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_GRV,
